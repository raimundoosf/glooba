...
export const CATEGORY_COLORS: Record<string, string> = {
  ...
  "Regalos corporativos": "text-red-500",
  Repuestos: "text-gray-500",
  "Servicios medioambientales": "text-blue-500",
  "Solar Fotovoltáica": "text-yellow-600",
  Tecnología: "text-gray-500",
  "Terraza y aire libre": "text-blue-600",
};

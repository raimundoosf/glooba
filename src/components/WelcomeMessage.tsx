      ...
      <CardHeader className="items-center text-center">
        ...
        <CardDescription className="text-base text-muted-foreground max-w-xl">
          <div className="space-y-2 mt-1">
            <p className="text-lg">Descubre organizaciones y empresas locales sostenibles. Nuestro buscador inteligente te ayuda a encontrar alternativas cercanas.</p>
            <div className="flex flex-wrap justify-center gap-2  ">
              ...
              <Link href="/about" className="group flex items-center gap-2 p-1.5 rounded bg-muted/50 hover:bg-muted-70 transition-colors">
